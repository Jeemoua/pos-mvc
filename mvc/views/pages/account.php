...
<div class="container-fluid p-0">
	<div class="row m-0">
		...
		<div class="p-0 bg1" style="height: 100vh;width: calc(100% - 320px)">
			<div class="p-3">
				<p class="float-left cl font-weight-bold mb-0" style="font-size: 130%">ຈັດການບັນຊີ</p>
			...
			<div style="height: calc(100vh - 120px);overflow-y: auto;">
				<form>
					<div class="py-2 px-4 cl bg2" style="width: 500px;margin: auto">
						<p class="text-center" style="font-size: 130%">what the hell</p>
						...
						<label class="mt-2">ລະຫັດຜ່ານໃໝ່</label>
						<input id="passwordRe" type="text" class="form-control"  style="background: none;color: white">
						<div class="text-center mt-3 mb-3">
							<div id="submit-button" class="btn bg-white text-dark">ປຽ່ນລະຫັດ</div>
						</div>	
