...
<div class="container-fluid p-0">
	<div class="row m-0">
		...
		<div class="p-0 bg1" style="height: 100vh;width: calc(100% - 320px)">
			<div class="p-3">
				<p id="logo-text" class="cl font-weight-bold float-right" style="font-size: 130%;">ຮ້ານອາຫານແບມໂບ</p>
				
				<div id="back-button" class="btn bg-white float-right" style="display: none;">ກັບຄືນ</div>
